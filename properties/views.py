...
class HouseViewSet(BaseViewSetWithAllPagination):
    ...
    @method_decorator(cache_page(60 * 5, key_prefix="house_list"))
    def list(self, request, *args, **kwargs):
    ...
    @method_decorator(cache_page(60 * 10, key_prefix="house_detail"))
    ...
    @method_decorator(cache_page(60 * 5, key_prefix="house_reviews"))
...
class CategoryViewSet(BaseViewSetWithAllPagination):
    ...
    @method_decorator(cache_page(60 * 30, key_prefix="category_list"))
    def list(self, request, *args, **kwargs):
        return super().list(request, *args, **kwargs)
